...
<a href="<?php echo base_url().'admin/transaksi_add'; ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> 
Transaksi Baru</a>
<br/><br/>
    ...
    <table class="table table-bordered table-striped table-hover" id="table-datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> 
                    <?php 
                    if($t->transaksi_status == "1"){  // jika status transaksi nantinya sama dengan 1 maka tampil “selesai” pada kolum status di tabel transaksi
                        echo "-";
                    }else{
                    ?>
                    <a class="btn btn-sm btn-success" 
                    href="<?php echo base_url().'admin/transaksi_selesai/'.$t->transaksi_id; ?>"><span class="glyphicon glyphicon-ok"></span> 
                    Transaksi Selesai</a>
                    <br/>
                    <a class="btn btn-sm btn-danger" 
                    href="<?php echo base_url().'admin/transaksi_hapus/'.$t->transaksi_id; ?>"><span class="glyphicon glyphicon-remove"></span> 
